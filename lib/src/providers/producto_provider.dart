...
class ProductosProvider {
  final String _url =
      'https://flutter-login-productos-default-rtdb.firebaseio.com/';
  ...
  Future subirImagen(File imagen) async {
    final url = Uri.parse(
        'https://api.cloudinary.com/v1_1/dy0v1l6x9/image/upload?upload_preset=aqjuors9');
